function calcolaLivello() {
    ...
    if (esercizio === "squat") {
        ...
        else if (rapporto < 1.5) { livello = "Intermedio"; classeCss = "livello-intermedio";}
        else if (rapporto < 2.0) { livello = "Avanzato"; classeCss = "livello-avanzato";}
        else { livello = "Elite"; classeCss = "livello-elite";}
    }
    else if (esercizio === "panca") {
        if (rapporto < 0.8) { livello = "Principiante"; classeCss = "livello-principiante";}
        else if (rapporto < 1.1) { livello = "Intermedio"; classeCss = "livello-intermedio";}
        else if (rapporto < 1.4) { livello = "Avanzato"; classeCss = "livello-avanzato";}
        else { livello = "Elite"; classeCss = "livello-elite";}
    }
    else if (esercizio === "stacco") {
        if (rapporto < 1.3) { livello = "Principiante"; classeCss = "livello-principiante";}
        else if (rapporto < 1.8) { livello = "Intermedio"; classeCss = "livello-intermedio";}
        else if (rapporto < 2.3) { livello = "Avanzato"; classeCss = "livello-avanzato";}
        else { livello = "Elite"; classeCss = "livello-elite";}
    }
